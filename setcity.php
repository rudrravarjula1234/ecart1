...
<div class="header" >
<div class="mini" style="display:inline-table;padding:5px;background:#CC0024;border:#DC143C;width:100%; margin-top:30px;color:honeydew;">
...
position: relative;">
					...
					/*if (isset($_SESSION['username'])) {
					    echo '<li><a href="logout.php"  style="color:honeydew;"><i class="fa fa-user" style="color:honeydew;" aria-hidden="true"></i>Logout('.$_SESSION['email'].')</a></li>';
					} else {
		...
		<div class="container-fluid" style="background:#DC143C;">
			...
			<img src="images/hello.png" class="img-responsive" style="height:130px;">
			<div class="search-form" style="position:relative;left:0em;top:70px;">
			...
			<!----- navbar-->
									...
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												...
												<li><a href="products.php?category=eggless"><i class="fa fa-angle-right" aria-hidden="true"></i>Egg less Cakes</a></li>
					...
					<!----- navbar--
					 <div class="cart" style="position:absolute;top:60px;right:80px;color:honeydew;border-radius:5px;border:2px solid honeydew;padding:10px;padding-right:50px;" >
						<b>CART</b>&nbsp|&nbsp<span class="fa fa-shopping-cart my-cart-icon" style="color:honeydew;"><span class="badge badge-notify my-cart-badge"></span></span>
					</div>
...
<center>
    ...
    <form action="cityprocess.php" method="post">
        <select name="city" style="width:30%;padding: 10px;">
    							<?php
        ...
        <input type="submit" style="padding: 12px; color:white;  background-color: #DC143C; border: none;"><br><br>
<br><br><br><br>
    </form>
</center>
<?php
