...
<body style="margin-top:0px;padding:0px;outline:0px;overflow-x:hidden;">
<div class="header" >
<div class="mini" style="display:inline-table;padding:5px;background:#CC0024;border:#DC143C;width:100%; margin-top:0px;color:honeydew;">
		...
		<div class="container-fluid" style="background:#DC143C;">
		  <div class="container-fluid">
		   <div clasas="row">
			...
			<img src="images/hello.png" class="img-responsiv" style="height:135px;">
			  </div>     	
			  <div class="col-md-4">		
			<div class="search-form" style="">
				<form action="products.php" method="get">
					<input type="text" placeholder="Search..." name="category" style="width:70%;top:15%;" >
  			...
  			<div class="col-md-4">
					 <div class="cart" style="vertical-align:center;position:absolute;top:35%;right:20%;" >
			...
			<!-- search bar end-->
				...
				<div class="nav-top">
				<!----- navbar-->
					<nav class="navbar navbar-default" style="background:#DC143C;border-radius:0px;" >
