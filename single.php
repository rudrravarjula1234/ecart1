...
<div id="picture-frame">
			<img src="images/<?php echo $row['image']; ?>" data-src="images/<?php echo $row['image']; ?>" alt="" class="img-responsive"/>
		</div>
			...
			<div class="col-md-7 single-top-left ">
				...
				<h3><?php echo $row['name']; ?></h3>
				 ...
				 <div class="pr-single">
				  <p class="reduced "><del>&#8377;<?php echo $row['actual']; ?></del>&#8377;<?php echo $row['price']; ?></p>
				</div>
				...
				<div class="block block-w3">
					<p class="in-pa">Product Detail: <?php echo $row['longName']; ?> </p>
				</div>
				<p class="in-pa"> <?php echo $row['description']; ?> </p>
			   	<!-- 
				<ul class="social-top">
					...
					<div class="add add-3">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="<?php echo $row['id']; ?>" data-name="<?php echo $row['name']; ?>" data-summary="<?php echo $row['longName']; ?>" data-price="<?php echo $row['price']; ?>" data-quantity="1" data-image="images/<?php echo $row['image']; ?>">Add to Cart</button>
										</div>
